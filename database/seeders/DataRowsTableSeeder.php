...
class DataRowsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $blogsDataType = DataType::where('slug', 'blogs')->firstOrFail();
        ...
        $dataRow = $this->dataRow($blogsDataType, 'id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'number',
                'display_name' => __('voyager::seeders.data_rows.id'),
        ...
        $dataRow = $this->dataRow($blogsDataType, 'category');
        if (!$dataRow->exists) {
            $dataRow->fill([
        ...
        $dataRow = $this->dataRow($blogsDataType, 'banner');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'image',
                'display_name' => 'Banner',
        ...
        $dataRow = $this->dataRow($blogsDataType, 'title');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'text',
                'display_name' => 'Title',
        ...
        $dataRow = $this->dataRow($blogsDataType, 'short_description');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'text_area',
        ...
        $dataRow = $this->dataRow($blogsDataType, 'content');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'rich_text_box',
        ...
        $dataRow = $this->dataRow($blogsDataType, 'image');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'image',
                'display_name' => 'Image',
        ...
        $dataRow = $this->dataRow($blogsDataType, 'status');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'select_dropdown',
                'display_name' => 'Status',
        ...
        $dataRow = $this->dataRow($blogsDataType, 'published_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'date',
                'display_name' => 'Publishe At',
                'required' => 1,
                'browse' => 1,
                'read' => 1,
                'edit' => 1,
        ...
        $dataRow = $this->dataRow($blogsDataType, 'meta_title');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'text_area',
        ...
        $dataRow = $this->dataRow($blogsDataType, 'meta_keywords');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'text_area',
        ...
        $dataRow = $this->dataRow($blogsDataType, 'meta_description');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'text_area',
        ...
        $dataRow = $this->dataRow($blogsDataType, 'created_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'timestamp',
                'display_name' => __('voyager::seeders.data_rows.created_at'),
        ...
        $dataRow = $this->dataRow($blogsDataType, 'updated_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'timestamp',
                'display_name' => __('voyager::seeders.data_rows.updated_at'),
        ...
        $dataRow = $this->dataRow($blogsDataType, 'blog_belongsto_user_relationship');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'relationship',
                'display_name' => 'User',
